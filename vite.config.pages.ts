  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        // The public "Sign" demo is intentionally not built/published.
        // Source is kept in the repo (sign/index.html + composables) so it
        // can be re-enabled, but it is unreachable from the public site.
