...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'land.hero.sub': 'Attestto checks integrity, digital signatures and certificate chains for any file, PDF, Word, anything, entirely inside your browser. No upload, no server, no account.',
  ...
  es: {
    ...
    'land.hero.sub': 'Attestto comprueba la integridad, las firmas digitales y las cadenas de certificados de cualquier archivo, PDF, Word, lo que sea, completamente dentro de tu navegador. Sin subidas, sin servidor, sin cuenta.',
