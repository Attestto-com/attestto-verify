...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'land.nav.privacy': 'Privacy',
    'land.nav.signatures': 'Signatures',
    ...
    'land.preview.idle': 'Idle',
    'land.preview.scanning': 'Scanning',
    'land.preview.verified': 'Verified',
    'land.preview.unsigned': 'No valid signature',
    'land.preview.issue': 'Issue found',
    'land.stats.uploaded': 'Bytes ever uploaded',
    'land.stats.standards': 'Signature standards checked',
    'land.stats.browser': 'Runs in your browser',
    'land.stats.browsers': 'Browsers supported',
    ...
    'land.cap.clientSide': 'Client-side',
    ...
    'comp.verify.dropHint': 'Signed PDF only — never leaves your device',
    'comp.verify.pdfOnly': 'Only PDF files are supported. Please drop a PDF.',
    ...
    'comp.verify.jurisdiction': 'Jurisdiction',
    'comp.verify.method': 'Method',
    'comp.verify.certificate': 'Certificate',
    'comp.verify.capabilities': 'Capabilities',
    ...
    // Extended Key Usage tooltips
    'comp.verify.eku.serverAuth': 'Can authenticate a server (TLS/HTTPS)',
    'comp.verify.eku.clientAuth': 'Can authenticate a client to a server',
    'comp.verify.eku.codeSigning': 'Can sign software code and executables',
    'comp.verify.eku.emailProtection': 'Can sign and encrypt email (S/MIME)',
    'comp.verify.eku.timeStamping': 'Can issue trusted timestamps',
    'comp.verify.eku.ocspSigning': 'Can sign OCSP responses (certificate status)',
    'comp.verify.eku.documentSigning': 'Can sign documents (PDF, Office, etc.)',
  ...
  es: {
    ...
    // ── Landing page (rebuild) ───────────────────────────
    'land.nav.howItWorks': 'Cómo funciona',
    'land.nav.privacy': 'Privacidad',
    'land.nav.signatures': 'Firmas',
    ...
    'land.preview.idle': 'Inactivo',
    'land.preview.scanning': 'Escaneando',
    'land.preview.verified': 'Verificado',
    'land.preview.unsigned': 'Sin firma válida',
    'land.preview.issue': 'Problema detectado',
    'land.stats.uploaded': 'Bytes jamás subidos',
    'land.stats.standards': 'Estándares de firma comprobados',
    'land.stats.browser': 'Se ejecuta en tu navegador',
    'land.stats.browsers': 'Navegadores compatibles',
    ...
    'land.cap.clientSide': 'En el navegador',
    ...
    'comp.verify.jurisdiction': 'Jurisdicción',
    'comp.verify.method': 'Método',
    'comp.verify.certificate': 'Certificado',
    'comp.verify.capabilities': 'Capacidades',
    ...
    // Extended Key Usage tooltips
    'comp.verify.eku.serverAuth': 'Puede autenticar un servidor (TLS/HTTPS)',
    'comp.verify.eku.clientAuth': 'Puede autenticar un cliente ante un servidor',
    'comp.verify.eku.codeSigning': 'Puede firmar código de software y ejecutables',
    'comp.verify.eku.emailProtection': 'Puede firmar y cifrar correo electrónico (S/MIME)',
    'comp.verify.eku.timeStamping': 'Puede emitir marcas de tiempo confiables',
    'comp.verify.eku.ocspSigning': 'Puede firmar respuestas OCSP (estado de certificados)',
    'comp.verify.eku.documentSigning': 'Puede firmar documentos (PDF, Office, etc.)',
